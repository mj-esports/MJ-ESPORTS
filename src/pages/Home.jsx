...
export default function Home() {
  ...
  return (
    <div className="flex-grow flex flex-col w-full bg-[#131314] text-[#e5e2e3] font-body antialiased selection:bg-[#00f2ff]/30 selection:text-[#00f2ff]">
      ...
      <section className="relative w-full min-h-[380px] md:min-h-[460px] flex items-center justify-center overflow-hidden py-10 md:py-16">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
          {/* Hero Greeting */}
          <span className="px-3.5 py-1 rounded bg-[#141416] border border-[#00f2ff]/30 text-[#00f2ff] text-[14px] sm:text-[15px] font-label-bold uppercase tracking-wider mb-4 inline-flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(0,242,255,0.2)]">
            👋 Welcome back, {displayName}
          </span>

          {/* Hero Title */}
          <h1 className="font-headline font-extrabold text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight text-white mb-4 uppercase drop-shadow-2xl leading-tight max-w-full break-words">
            READY FOR BATTLE?
          </h1>

          {/* Hero Description */}
          <p className="font-body text-[#b9cacb] text-[15px] sm:text-[17px] max-w-2xl mx-auto mb-8 font-normal leading-relaxed line-clamp-2 sm:line-clamp-none">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto items-center justify-center">
            <Link
              to="/tournaments"
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 bg-[#00f2ff] text-[#00363a] font-headline font-bold text-sm sm:text-base rounded hover:bg-[#74f5ff] transition-all duration-200 shadow-[0_0_20px_rgba(0,242,255,0.35)] flex items-center justify-center gap-2 uppercase tracking-wider min-h-[48px]"
            >
            ...
            <Link
              to="/leaderboard"
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 bg-[#141416] text-[#e5e2e3] font-headline font-bold text-sm sm:text-base rounded hover:bg-[#201f20] hover:text-[#00f2ff] hover:border-[#00f2ff]/50 transition-all duration-200 border border-[#27272a] flex items-center justify-center gap-2 uppercase tracking-wider min-h-[48px]"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-6 md:-mt-12 relative z-20 pb-20 space-y-10 sm:space-y-12">
        ...
        <section className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6">
          <Link to="/tournaments" className="flex flex-col items-center gap-2 sm:gap-3 group">
            ...
            <span className="font-label-bold text-[10px] xs:text-xs sm:text-xs font-bold text-[#b9cacb] group-hover:text-[#00f2ff] transition-colors text-center leading-tight uppercase">
              Join<br />Tourneys
            </span>
          </Link>
          ...
          <Link to="/profile/history" className="flex flex-col items-center gap-2 sm:gap-3 group">
            ...
            <span className="font-label-bold text-[10px] xs:text-xs sm:text-xs font-bold text-[#b9cacb] group-hover:text-[#ff5e07] transition-colors text-center leading-tight uppercase">
              My<br />Matches
            </span>
          </Link>
          ...
          <Link to="/wallet" className="flex flex-col items-center gap-2 sm:gap-3 group">
            ...
            <span className="font-label-bold text-[10px] xs:text-xs sm:text-xs font-bold text-[#b9cacb] group-hover:text-[#10b981] transition-colors text-center leading-tight uppercase">
              Wallet
            </span>
          </Link>
          ...
          <Link to="/leaderboard" className="flex flex-col items-center gap-2 sm:gap-3 group">
            ...
            <span className="font-label-bold text-[10px] xs:text-xs sm:text-xs font-bold text-[#b9cacb] group-hover:text-[#fed83a] transition-colors text-center leading-tight uppercase">
              Ranks
            </span>
          </Link>
        </section>
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <section className="lg:col-span-2">
                <div className="flex items-center justify-between mb-4 sm:mb-6 gap-2">
                  <h2 className="font-headline font-extrabold text-sm xs:text-base sm:text-2xl uppercase tracking-wider text-white flex items-center gap-2 sm:gap-3 min-w-0">
                    ...
                    upcomingTournaments.map((t, idx) => (
                      <div key={`upcoming-tourney-${t.id || t._id || idx}`} className="bg-[#141416] rounded border border-[#27272a] overflow-hidden hover:border-[#00f2ff] transition-colors group flex flex-col">
                        ...
                        <div className="p-4 flex flex-col flex-grow">
                          ...
                          <p className="text-xs text-[#b9cacb] mb-4 font-body">{t.game}</p>

                          <div className="grid grid-cols-2 gap-2 mb-4">
                            <div className="flex flex-col">
                              <span className="text-[10px] text-[#849495] uppercase font-label-bold">Entry Fee</span>
                              <span className="font-bold text-white text-sm font-headline">{t.entryFee || t.entry_fee || 'Free'}</span>
                            </div>
                            <div className="flex flex-col items-end">
                              <span className="text-[10px] text-[#849495] uppercase font-label-bold">Prize Pool</span>
                              <span className="font-bold text-[#ff5e07] text-sm font-headline">{formatTournamentPrize(t)}</span>
                            </div>
                          </div>

                          <div className="flex justify-between items-center text-[11px] text-[#b9cacb] mb-2 font-medium">
                            <span>Starts: {t.startDate} &bull; {t.startTime}</span>
                          </div>

                          <div className="mb-4 mt-auto">
                            <div className="flex justify-between text-xs mb-1">
                              <span className="text-[#849495] text-[11px] font-label-bold">Registration</span>
                              <span className="text-[#00f2ff] font-bold text-[11px]">{calculateFilledPlayerSlots(t)}/{calculateTotalPlayerSlots(t)} Slots</span>
                            </div>
                          ...
                          <Link
                            to={`/tournaments/${t.id}`}
                            className="w-full py-2.5 bg-[#1c1b1c] hover:bg-[#00f2ff] text-white hover:text-[#00363a] font-headline font-bold text-xs uppercase tracking-wider rounded transition-colors border border-[#27272a] hover:border-[#00f2ff] text-center block min-h-[44px] flex items-center justify-center"
                          >
                            Register Now
                          </Link>
                        </div>
              ...
              <section className="lg:col-span-1">
                <div className="flex items-center justify-between mb-4 sm:mb-6 gap-2">
                  <h2 className="font-headline font-extrabold text-base xs:text-lg sm:text-2xl uppercase tracking-wider text-white flex items-center gap-2 sm:gap-3 min-w-0">
                ...
                <div className="bg-[#141416] rounded border border-[#27272a] p-3 space-y-2">
                  {topPlayers.length === 0 ? (
                    <div className="py-12 text-center text-xs text-[#b9cacb] font-sans">
                      ...
                      return (
                        <div key={`top-player-${p.player}-${idx}`} className="flex items-center gap-3 p-3 rounded bg-[#1c1b1c] border border-[#27272a] hover:border-[#00f2ff]/40 transition-colors">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-headline font-bold text-xs text-white truncate">{p.player}</h4>
                            <p className="text-[10px] text-[#b9cacb] uppercase truncate">{p.kills} Kills &bull; {p.team}</p>
                          </div>
                          <div className="text-right shrink-0">
                            <span className="font-headline font-bold text-sm text-white font-mono">{p.points}</span>
                            <p className="text-[9px] text-[#849495] uppercase font-label-bold">PTS</p>
                          </div>
                        </div>
                      )
                    })
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-3 xs:gap-4 sm:gap-6 bg-[#141416] rounded p-4 xs:p-5 sm:p-8 border border-[#27272a] shadow-xl relative overflow-hidden">
              <div className="flex flex-col items-center justify-center text-center p-2 sm:p-3 relative z-10">
                <span className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-headline font-black text-[#00f2ff] leading-none tracking-tight drop-shadow-[0_0_15px_rgba(0,242,255,0.4)]">
                  {activeCount}
                </span>
                <span className="text-[9px] xs:text-[10px] sm:text-xs text-[#b9cacb] uppercase font-label-bold tracking-widest mt-2 leading-tight">
                  Active Tournaments
                </span>
              </div>

              <div className="flex flex-col items-center justify-center text-center p-2 sm:p-3 relative z-10">
                <span className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-headline font-black text-white leading-none tracking-tight">
                  {openCount}
                </span>
                <span className="text-[9px] xs:text-[10px] sm:text-xs text-[#b9cacb] uppercase font-label-bold tracking-widest mt-2 leading-tight">
                  Open Registrations
              ...
              <div className="flex flex-col items-center justify-center text-center p-2 sm:p-3 relative z-10">
                <span className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-headline font-black text-[#ff5e07] leading-none tracking-tight drop-shadow-[0_0_15px_rgba(255,94,7,0.35)]">
                  {totalPrizePool}
                </span>
                <span className="text-[9px] xs:text-[10px] sm:text-xs text-[#b9cacb] uppercase font-label-bold tracking-widest mt-2 leading-tight">
                  Total Prize Pool
                ...
                <div className="rounded p-1 relative overflow-hidden group bg-[#141416] border border-[#27272a] hover:border-[#00f2ff] transition-colors">
                  <div className="bg-[#141416] rounded p-5 sm:p-6 relative z-10 flex flex-col md:flex-row items-center gap-6 sm:gap-8">
                    <div className="w-full md:w-1/3 aspect-video rounded overflow-hidden relative shadow-lg bg-[#0e0e0f] shrink-0">
                      ...
                      />
                      <div className="absolute top-2 left-2 px-2.5 py-1 bg-[#10b981]/20 text-[#10b981] border border-[#10b981]/30 font-label-bold text-xs font-bold rounded uppercase tracking-wider flex items-center gap-1.5 backdrop-blur-sm">
                    ...
                    <div className="flex-1 flex flex-col w-full space-y-4">
                      <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="text-right shrink-0">
                          ...
                          <p className="font-headline font-black text-[#ff5e07] text-2xl sm:text-3xl lg:text-4xl drop-shadow-[0_0_12px_rgba(255,94,7,0.35)]">{upcomingTournaments[0].prizePool || upcomingTournaments[0].prize_pool}</p>
                        </div>
                      </div>
                      ...
                      <div className="bg-[#201f20] rounded p-4 border border-[#27272a]">
                        ...
                        <div className="flex items-center gap-3.5">
                          ...
                          <div className="flex-1 h-2.5 sm:h-3 bg-[#0e0e0f] rounded-full overflow-hidden border border-[#27272a]">
                            <div
                      ...
                      <div className="flex gap-4 pt-1">
                        <Link
                          ...
                          className="flex-1 py-3.5 bg-[#00f2ff] hover:bg-[#74f5ff] text-[#00363a] font-headline font-bold uppercase tracking-wider rounded transition-all flex items-center justify-center gap-2 text-center min-h-[48px] shadow-[0_0_15px_rgba(0,242,255,0.35)]"
                        >
                          Register Now
                        </Link>
                      </div>
