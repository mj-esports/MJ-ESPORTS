...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#07090c] border-t border-[#3a494b]/60 pt-6 sm:pt-8 pb-16 md:pb-6 text-[#b9cacb]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 pb-6 sm:pb-8 border-b border-[#3a494b]/40">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#151a21] border border-[#3a494b]/60 flex items-center justify-center text-[#5865F2] hover:scale-105 transition-transform"
              >
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#151a21] border border-[#3a494b]/60 flex items-center justify-center text-[#FF0000] hover:scale-105 transition-transform"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div className="space-y-3">
            <h4 className="font-label-caps text-xs text-[#e1e2e7]">Supported Games</h4>
            <ul className="space-y-2 text-xs">
          ...
          {/* Support & Contact */}
          <div className="space-y-3">
            <h4 className="font-label-caps text-xs text-[#e1e2e7]">Support</h4>
